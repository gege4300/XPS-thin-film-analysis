...
class Page3(Page):
    ...
    def getim(self,model):
        ...
        self.formulafig1=ImageTk.PhotoImage(Image.open("f1-model1").resize((552,70), Image.Resampling.LANCZOS))
        self.formulafig2=ImageTk.PhotoImage(Image.open("f2-model2").resize((614,70), Image.Resampling.LANCZOS))
        self.formulafig3=ImageTk.PhotoImage(Image.open("f3-model3").resize((775,70), Image.Resampling.LANCZOS))
