...
class Page1(Page):
    def __init__(self, *args, **kwargs):
        ...
        self.Label1_1_1_2.place(x=200, y=200, height=35, width=189)
...
class Page2(Page):
    def __init__(self, *args, **kwargs):
        ...
        self.Label1_1_1_2 = tk.Label(self)
        self.Label1_1_1_2.place(x=200, y=250, height=35, width=189)
        self.Label1_1_1_2.configure(activebackground="#f9f9f9")
        self.Label1_1_1_2.configure(anchor='w')
        self.Label1_1_1_2.configure(background="#262626")
        self.Label1_1_1_2.configure(compound='center')
    ...
    def getim(self,model):
        ...
        if self.TCombobox2.get()== "bulk":
            ...
            self.model1=tk.Label(self, image=self.modelfig2).place(x=220, y=330, height=150, width=150)
        elif self.TCombobox2.get()== "layer2":
            self.model1=tk.Label(self, image=self.modelfig3).place(x=220, y=330, height=150, width=150)
        elif self.TCombobox2.get()== "layer3":
            self.model1=tk.Label(self, image=self.modelfig4).place(x=220, y=330, height=150, width=150)
    # get snsitivity factors
    def getsf(self,element):
        global dir_path
        dir_path = os.path.dirname(os.path.realpath(__file__))
...
class MainView(tk.Frame):
    ...
    def __init__(self, top=None):
        ...
        p1.place(in_=container, x=0, y=0, width=800, height=500)
        p2.place(in_=container, x=0, y=0, width=800, height=500)
       

        self.atomratio = tk.Button(buttonframe)
        self.atomratio.place(x=0, y=10, height=30, width=91)
        self.atomratio.configure(activebackground="beige")
        self.atomratio.configure(background="#3498DB")
        self.atomratio.configure(borderwidth="2")
        self.atomratio.configure(command=p1.show)
        ...
        self.fthick.place(x=150, y=10, height=30, width=101)
        self.fthick.configure(activebackground="beige")
        self.fthick.configure(background="#3498DB")
        self.fthick.configure(borderwidth="2")
        self.fthick.configure(command=p2.show)
        ...
        self.closewindow.place(x=250, y=10, height=30, width=71)
